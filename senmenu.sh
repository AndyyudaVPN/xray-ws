...
wget -q -O /usr/bin/menun-ssh "https://raw.githubusercontent.com/AndyyudaVPN/xray-ws/main/menun-ssh.sh"
...
#wget -q -O /usr/bin/fix "https://raw.githubusercontent.com/AndyyudaVPN/xray-ws/main/domain.sh"
